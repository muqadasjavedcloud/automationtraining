...
cy.url().should('include', '/auth/sign-up'); 
 cy.get('#email').type('muqadasjaved101+test234@gmail.com');
 ...
 cy.get('input[name="Company Name"]').type('dm112 company');
 cy.get('input[name="NUIT Number"]').type('234622035');
 cy.get('input[name="Commercial Registration Number"]').type('63593239523');
